...
const displayDate = function (date) {
  ...
  else if (daysPassed === 1) return "Yesteraday";
...
console.log(calcDaysPassed(date1, date2) / (1000 * 60 * 60 * 24));
